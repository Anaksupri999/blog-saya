...
def register():
    ...
    if form.validate_on_submit():
        ...
        if User.query.filter_by(email=form.email.data).first():
            ...
            flash("Email Kamu Sudah Terdaftar silahkan langsung Log in")
...
def login():
    ...
    if form.validate_on_submit():
        ...
        if not user:
            flash("Email ini belum terdaftar silahkan daftar dahulu")
            return redirect(url_for('login'))
...
def show_post(post_id):
    ...
    if form.validate_on_submit():
        if not current_user.is_authenticated:
            flash("Kamu harus Login atau Register untuk Menulis Komentar")
            return redirect(url_for('login'))
